...
3. **Before Starting OpenPnP (each boot):** See [30-before-starting-openpnp.md](docs/30-before-starting-openpnp.md).
4. **OpenPnP ↔ Klipper driver (TCP bridge):** See [40-openpnp-driver.md](docs/40-openpnp-driver.md)
5. **Head rotation via fake extruder (EM/E0):** See [50-rotation-extruder.md](docs/50-rotation-extruder.md)
6. **Lights (ESP32 or SKR fans):** See [60-lights.md](docs/60-lights.md)
7. **Troubleshooting (Step → Problem → Solution):** See [70-troubleshooting.md](docs/70-troubleshooting.md)
